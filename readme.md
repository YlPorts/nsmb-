...
<!-- A2DE_PROGRESS_START -->
<p align="center">
  <a href="progress/A2DE.md"><img src="progress/A2DE.svg" width="720" alt="A2DE matching code: 4.401809%" /></a>
</p>

## **4.401809% matching code — this fork**

| Verified A2DE metric | Current result |
| --- | ---: |
| Matching code bytes | **126,616 / 2,876,454** |
| Matching functions | **1,506 / 15,667** |

Measured **2026-09-19**. The percentage is based on code bytes, not function count, playable levels or a PC/Android port.

**Latest pass: +0 matching functions / +0 code bytes.**
...
| --------------------------------------------------------------------------------------------------------------------------------------- | ------------ | ------------------- | ----------- |
| [New Super Mario Bros. (USA, Australia)](https://datomatic.no-intro.org/index.php?page=show_record&s=28&n=0434)                         | A2DE         | 2006-03-29 09:48:19 | [**4.401809% (this fork)**](progress/A2DE.md) |
