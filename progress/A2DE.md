...
| Goomba states and collision helpers | 83,204 | 2,876,454 | 2.892589% | 1,145 / 15,667 |

**Cumulative gain: 2,748 matching code bytes and 195 matching functions.** The code-size and function-count denominators have not changed. No previously matching function was lost, comparing each function's unit and original address rather than its possibly improved name.
...
This checkpoint adds **17 matching functions / 1,624 matching code bytes** over e764d7d. Goomba's unit now has 1,280 / 7,456 matching code bytes (13 / 28 matching functions); the class is still incomplete.
...
The reconstruction incorporates Ozero4's upstream contributions in NSMB-Decomp/nsmb#13, #14 and #15, and cappuch's cleanup routines from #11. Additional work corrects Object104's external helper linkage and Goomba's helper parameter types, reconstructs the StageEntity helper bodies, and verifies all reported gains locally.
